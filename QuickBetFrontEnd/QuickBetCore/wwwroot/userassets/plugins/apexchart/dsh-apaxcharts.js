...
$(document).ready(function () {
  ...
  var columnCtx = document.getElementById("dsh_chart_ex_column"),
    columnConfig = {
      ...
      series: [
        { name: "Total Tickets", data: [44, 55, 57, 56, 61, 58, 63] },
        { name: "Total Won", data: [76, 85, 101, 98, 87, 105, 91] },
        { name: "Total Loss", data: [35, 41, 36, 26, 45, 48, 52] },
      ],
  ...
  var pieCtx = document.getElementById("dsh_chart_ex_pie"),
    pieConfig = {
      colors: ["#323584"],
      series: [86],
      chart: { height: 390, type: "radialBar", offsetY: -10 },
      plotOptions: {
        radialBar: {
          startAngle: -135,
          endAngle: 135,
