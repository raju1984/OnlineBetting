...
namespace Quickbet.Areas.Agent.Controllers
{
    ...
    {
        // GET: Agent/Disputemanagement
        QuickbetDbEntities db = new QuickbetDbEntities();
        private UserSession userSession;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public DisputemanagementController(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public ActionResult GetDisputeChatHistory(int SupportTicketId)
        {
