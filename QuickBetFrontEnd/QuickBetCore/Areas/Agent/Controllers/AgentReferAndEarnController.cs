...
namespace QuickBetCore.Areas.Agent.Controllers
{
    public class AgentReferAndEarnController : Controller
    {
        private UserSession userSession;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IWebHostEnvironment webHostEnvironment;
        //Agent/AgentReferAndEarn
        public AgentReferAndEarnController(IHttpContextAccessor httpContextAccessor, IWebHostEnvironment hostEnvironment)
        {
